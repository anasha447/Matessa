...
class Title {
  ...
  createMesh() {
    ...
    // ✅ Position text just below plane (responsive)
...
class Media {
  ...
  onResize({ screen, viewport } = {}) {
    ...
    // ✅ Responsive scaling instead of fixed px
    this.plane.scale.y = this.viewport.height * (isMobile ? 0.5 : 0.7);
    this.plane.scale.x = this.viewport.width * (isMobile ? 0.7 : 0.5);

    this.plane.program.uniforms.uPlaneSizes.value = [this.plane.scale.x, this.plane.scale.y];

    // ✅ Adjust padding for carousel spacing
...
class App {
  ...
  createRenderer() {
    ...
    // ✅ Prevent clipping
    this.gl.canvas.style.overflow = "visible";
...
// React wrapper
export default function MateGallery(props) {
