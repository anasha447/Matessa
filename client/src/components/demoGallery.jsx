...
const DEFAULT_IMAGES = [
  ...
  { src: img7, alt: "Digital artwork" },
  { src: img3, alt: "Contemporary art" },
  { src: img4, alt: "Geometric pattern" },
  { src: img5, alt: "Textured surface" },
  { src: img6, alt: "Social media image" },
  { src: img8, alt: "Social media image" },
  { src: img9, alt: "Social media image" },
  { src: img10, alt: "Social media image" },
];
    ...
    <>
      ...
      <div
        ...
        className="
          ...
          box-border overflow-hidden overflow-x-hidden
          ...
          <div className="stage">
            <div ref={sphereRef} className="sphere">
              {items.map((it, i) => (
                ...
                >
                  <div
                    className="item__image group absolute block bg-gray-200 transition-transform duration-300"
                    role="button"
                    tabIndex={0}
