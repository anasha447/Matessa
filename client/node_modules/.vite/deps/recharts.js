...
import {
  ...
  createSlice,
  current
} from "./chunk-H2SVGSLL.js";
import {
  require_react_dom
} from "./chunk-D7552MD7.js";
import {
  Provider_default
} from "./chunk-THLP32HC.js";
import "./chunk-W2CKBSLV.js";
import {
  require_react
...
var require_uniqBy2 = __commonJS({
  "node_modules/es-toolkit/dist/compat/array/uniqBy.js"(exports) {
    ...
    function uniqBy3(array, iteratee$1 = identity4.identity) {
...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React74 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState20 = React74.useState, useEffect28 = React74.useEffect, useLayoutEffect2 = React74.useLayoutEffect, useDebugValue = React74.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React74 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore = shim.useSyncExternalStore, useRef17 = React74.useRef, useEffect28 = React74.useEffect, useMemo9 = React74.useMemo, useDebugValue = React74.useDebugValue;
  ...
  "node_modules/es-toolkit/dist/compat/_internal/isIterateeCall.js"(exports) {
    ...
    function isIterateeCall(value, index, object) {
      ...
      if (typeof index === "number" && isArrayLike.isArrayLike(object) && isIndex.isIndex(index) && index < object.length || typeof index === "string" && index in object) {
        return eq2.eq(object[index], value);
      }
      return false;
    }
    ...
    function areObjectsEqual(a2, b, stack, areValuesEqual) {
      ...
      try {
        switch (aTag) {
          ...
          case tags.objectTag: {
            const areEqualInstances = areObjectsEqual(a2.constructor, b.constructor, stack, areValuesEqual) || isPlainObject4.isPlainObject(a2) && isPlainObject4.isPlainObject(b);
...
var require_isEqual = __commonJS({
  "node_modules/es-toolkit/dist/predicate/isEqual.js"(exports) {
    ...
    function isEqual3(a2, b) {
      return isEqualWith2.isEqualWith(a2, b, noop6.noop);
    }
...
var require_eventemitter3 = __commonJS({
  "node_modules/eventemitter3/index.js"(exports, module) {
    ...
    function addListener(emitter, event, fn, context, once2) {
      ...
      var listener = new EE(fn, context || emitter, once2), evt = prefix2 ? prefix2 + event : event;
...
var require_maxBy2 = __commonJS({
  "node_modules/es-toolkit/dist/compat/math/maxBy.js"(exports) {
    ...
    function maxBy4(items, iteratee$1) {
      ...
      return maxBy$1.maxBy(Array.from(items), iteratee.iteratee(iteratee$1 ?? identity4.identity));
    }
    exports.maxBy = maxBy4;
  }
});
...
var require_minBy2 = __commonJS({
  "node_modules/es-toolkit/dist/compat/math/minBy.js"(exports) {
    ...
    function minBy3(items, iteratee$1) {
      ...
      return minBy$1.minBy(Array.from(items), iteratee.iteratee(iteratee$1 ?? identity4.identity));
    }
    exports.minBy = minBy3;
  }
});
...
var require_sumBy = __commonJS({
  "node_modules/es-toolkit/dist/compat/math/sumBy.js"(exports) {
    ...
    Object.defineProperty(exports, Symbol.toStringTag, { value: "Module" });
    var iteratee = require_iteratee();
    function sumBy3(array, iteratee$1) {
      ...
      for (let i = 0; i < array.length; i++) {
        const current2 = iteratee$1 ? iteratee$1(array[i]) : array[i];
        if (current2 !== void 0) {
          if (result === void 0) {
            result = current2;
          } else {
...
var calculateActiveTickIndex = (coordinate, ticks, unsortedTicks, axisType, range5) => {
  var _ticks$length;
  var index = -1;
  ...
  if (axisType === "angleAxis" && range5 != null && Math.abs(Math.abs(range5[1] - range5[0]) - 360) <= 1e-6) {
    for (var i = 0; i < len; i++) {
      ...
      if (mathSign(cur - before2) !== mathSign(after2 - cur)) {
        var diffInterval = [];
        if (mathSign(after2 - cur) === mathSign(range5[1] - range5[0])) {
          ...
          var afterInRange = after2 + range5[1] - range5[0];
...
var getBandSizeOfAxis = (axis, ticks, isBar) => {
  ...
  if (axis && ticks && ticks.length >= 2) {
    var orderedTicks = (0, import_sortBy2.default)(ticks, (o) => o.coordinate);
...
var AnimateImpl = class extends import_react15.PureComponent {
  ...
  render() {
    ...
    var count = import_react15.Children.count(children);
...
var import_range = __toESM(require_range2());
...
var _calculateStep = function calculateStep(min2, max2, tickCount, allowDecimals) {
  ...
  var step = getFormatStep(new decimal_default(max2).sub(min2).div(tickCount - 1), allowDecimals, correctionFactor);
  var middle;
  if (min2 <= 0 && max2 >= 0) {
    middle = new decimal_default(0);
  } else {
    middle = new decimal_default(min2).add(max2).div(2);
    middle = middle.sub(new decimal_default(middle).mod(step));
  }
  var belowCount = Math.ceil(middle.sub(min2).div(step).toNumber());
  var upCount = Math.ceil(new decimal_default(max2).sub(middle).div(step).toNumber());
...
var computeDomainOfTypeCategory = (allDataSquished, axisSettings, isCategorical) => {
  ...
  if (isCategorical && (axisSettings.dataKey == null || axisSettings.allowDuplicatedCategory && hasDuplicate(categoricalDomain))) {
    return (0, import_range.default)(0, allDataSquished.length);
  }
...
var combineAxisDomain = (axisSettings, layout, displayedData, allAppliedValues, stackOffsetType, axisType, numericalDomain) => {
  ...
  if (isCategorical && dataKey == null) {
    return (0, import_range.default)(0, displayedData.length);
  }
  if (type === "category") {
...
var selectOrderedTooltipTicks = createSelector(selectTooltipAxisTicks, (ticks) => (0, import_sortBy4.default)(ticks, (o) => o.coordinate));
...
var DecimalCSS = class _DecimalCSS {
  static parse(str) {
    ...
    return new _DecimalCSS(parseFloat(numStr), unit !== null && unit !== void 0 ? unit : "");
  }
  ...
  return React17.createElement("text", _extends13({}, filterProps(textProps, true), {
    ...
    return (
      ...
      React17.createElement("tspan", {
        ...
        key: "".concat(words2, "-").concat(index)
      }, words2)
    );
  }));
});
...
function renderCallByParent3(parentProps, data) {
  ...
  var explicitChildren = findAllByType(children, LabelList).map((child, index) => (0, import_react24.cloneElement)(child, {
    data,
    // eslint-disable-next-line react/no-array-index-key
...
var getSinglePolygonPath = (points, connectNulls) => {
  ...
  var polygonPath = segmentPoints.map((segPoints) => {
    return segPoints.reduce((path2, point6, index) => {
      return "".concat(path2).concat(index === 0 ? "M" : "L").concat(point6.x, ",").concat(point6.y);
    }, "");
  }).join("");
...
var selectPolarGridAngles = createSelector([selectAngleAxisTicks], (ticks) => {
  if (!ticks) {
    return void 0;
  }
...
var selectPolarGridRadii = createSelector([selectRadiusAxisTicks], (ticks) => {
  if (!ticks) {
    return void 0;
  }
  return ticks.map((tick) => tick.coordinate);
...
function SectorsWithAnimation(_ref3) {
  ...
  return React30.createElement(JavascriptAnimate, {
    ...
    sectors.forEach((entry, index) => {
      ...
      var paddingAngle = index > 0 ? (0, import_get5.default)(entry, "paddingAngle", 0) : 0;
      if (prev) {
        var angleIp = interpolateNumber(prev.endAngle - prev.startAngle, entry.endAngle - entry.startAngle);
        var latest = _objectSpread30(_objectSpread30({}, entry), {}, {
...
function getIndex(_ref2) {
  ...
  var minIndex = getIndexInRange(scaleValues, min2);
  var maxIndex = getIndexInRange(scaleValues, max2);
  return {
...
var createScale = (_ref7) => {
  ...
  var len = data.length;
  var scale = point().domain((0, import_range3.default)(0, len)).range([x2, x2 + width - travellerWidth]);
...
var ScaleHelper = class _ScaleHelper {
  ...
  isInRange(value) {
    ...
    var first = range5[0];
    var last4 = range5[range5.length - 1];
...
function getEquidistantTicks(sign2, boundaries, getTickSize, ticks, minTickGap) {
...
function getTicksEnd(sign2, boundaries, getTickSize, ticks, minTickGap) {
  var result = (ticks || []).slice();
...
function getTicksStart(sign2, boundaries, getTickSize, ticks, minTickGap, preserveEnd) {
  var result = (ticks || []).slice();
  var len = result.length;
  var {
    start,
...
function getTicks(props, fontSize, letterSpacing) {
  ...
  var sign2 = ticks.length >= 2 ? mathSign(ticks[1].coordinate - ticks[0].coordinate) : 1;
  var boundaries = getTickBoundaries(viewBox, sign2, sizeKey);
  if (interval === "equidistantPreserveStart") {
    return getEquidistantTicks(sign2, boundaries, getTickSize, ticks, minTickGap);
  }
  if (interval === "preserveStart" || interval === "preserveStartEnd") {
    candidates = getTicksStart(sign2, boundaries, getTickSize, ticks, minTickGap, interval === "preserveStartEnd");
  } else {
    candidates = getTicksEnd(sign2, boundaries, getTickSize, ticks, minTickGap);
  }
...
var CartesianAxis = class _CartesianAxis extends import_react49.Component {
  ...
  renderTicks(fontSize, letterSpacing) {
    ...
    var items = finalTicks.map((entry, i) => {
      ...
      })), tick && _CartesianAxis.renderTickItem(tick, tickProps, "".concat(typeof tickFormatter === "function" ? tickFormatter(entry.value, i) : entry.value).concat(unit || "")));
    });
...
var MainChartSurface = (0, import_react61.forwardRef)((props, ref) => {
  ...
  return React55.createElement(Surface, _extends41({}, otherAttributes, {
    title,
    desc,
    role,
    tabIndex,
...
var RootSurface = (0, import_react61.forwardRef)((_ref2, ref) => {
  ...
  return React55.createElement(MainChartSurface, _extends41({
    ref
  }, rest2), children);
});
...
var CartesianChart = (0, import_react65.forwardRef)(function CartesianChart2(props, ref) {
  ...
  }), React58.createElement(CategoricalChart, _extends42({}, otherCategoricalProps, {
    width,
    height,
    ref
  })));
...
var PolarChart = (0, import_react69.forwardRef)(function PolarChart2(props, ref) {
  ...
  }), React61.createElement(CategoricalChart, _extends43({
    width,
    height
...
function ContentItem(_ref2) {
  ...
  return React63.createElement("g", null, React63.createElement(Rectangle, _extends44({
...
function ContentItemWithEvents(props) {
  ...
  return React63.createElement(ContentItem, _extends44({}, props, {
    onMouseEnter,
    onMouseLeave,
    onClick
  }));
...
var TreemapWithState = class extends import_react71.PureComponent {
  ...
  renderItem(content, nodeProps, isLeaf) {
    ...
    }, (style) => React63.createElement(Layer, _extends44({}, event, {
      style
...
function TreemapDispatchInject(props) {
  var dispatch = useAppDispatch();
  return React63.createElement(TreemapWithState, _extends44({}, props, {
    dispatch
  }));
}
...
var sankeyPayloadSearcher = (_, activeIndex, computedData, nameKey) => {
  ...
  var item = (0, import_get8.default)(computedData, "".concat(targetType, "s[").concat(index, "]"));
  if (item) {
...
function renderLinkItem(option, props) {
  ...
  return React64.createElement("path", _extends45({
...
function renderNodeItem(option, props) {
  ...
  return (
    ...
    React64.createElement(Rectangle, _extends45({
...
var Sankey = class extends import_react72.PureComponent {
  ...
  render() {
    ...
    return React64.createElement(RechartsStoreProvider, {
      ...
      onTouchMove: void 0,
      onTouchEnd: void 0
    }, React64.createElement(Surface, _extends45({}, attrs, {
      width,
      height
    ...
    childNodes.forEach((d, i) => {
      ...
      sectors.push(
        ...
        React70.createElement("g", {
          ...
          cx,
          cy
        }), React70.createElement(Text, _extends46({}, textOptions, {
          alignmentBaseline: "middle",
          textAnchor: "middle",
          x: textX + cx,
          y: cy - textY
...
function FunnelTrapezoid(props) {
  return React71.createElement(Shape, _extends47({
    shapeType: "trapezoid",
...
var selectFunnelTrapezoids = createSelector([selectChartOffsetInternal, pickFunnelSettings, selectChartDataAndAlwaysIgnoreIndexes], (offset, _ref2, _ref22) => {
  ...
  if (displayedData && displayedData.length) {
    displayedData = displayedData.map((entry, index) => _objectSpread59(_objectSpread59(_objectSpread59({
      payload: entry
...
function FunnelTrapezoids(props) {
  ...
  return React72.createElement(React72.Fragment, null, trapezoids.map((entry, i) => {
    ...
    return React72.createElement(Layer, _extends48({
...
function TrapezoidsWithAnimation(_ref2) {
  ...
  return React72.createElement(JavascriptAnimate, {
    begin: animationBegin,
    duration: animationDuration,
    isActive: isAnimationActive,
    easing: animationEasing,
...
function RenderTrapezoids(props) {
  ...
  return React72.createElement(FunnelTrapezoids, {
    trapezoids,
    allOtherFunnelProps: props,
    showLabels: true
  });
...
function FunnelImpl(props) {
  ...
  }), hide ? null : React72.createElement(FunnelWithState, _extends48({}, everythingElse, {
    stroke,
    fill: fill2,
    nameKey,
    lastShapeType,
