...
import com.ecommerce.matessa.services.AddressService;
...
public class AddressController {
    ...
    @GetMapping("/admin/users/addresses")
    ...
    public ResponseEntity<String> deleteAddress(@PathVariable Long addressId){ // <--- Renamed
